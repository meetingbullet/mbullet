<div class="<?php echo $this->input->is_ajax_request() ? '' : 'an-content-body'?>">
		...
		<div class='container-fluid<?php echo $this->input->is_ajax_request() ? ' modal-body' : ''?>'>
			...
			<?php echo mb_form_input('text', 'team_point', lang('pj_project_cost'), false, set_value('team_point', empty($draft) || empty($draft->team_point) ? '' : $draft->team_point), 'an-form-control', '', lang('pj_project_team_hours')) ?>
