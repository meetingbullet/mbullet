<div class="<?php echo $this->input->is_ajax_request() ? '' : 'an-content-body'?>">
		...
		<div class='container-fluid<?php echo $this->input->is_ajax_request() ? ' modal-body' : ''?>'>
			...
			<?php echo mb_form_input('text', 'deadline', lang('pj_project_deadline'), false, '', 'an-form-control', '', '', '', 'id="project-deadline"') ?>
			<?php echo mb_form_input('text', 'team_point', lang('pj_project_cost'), false, '', 'an-form-control', '', lang('pj_project_team_hours')) ?>
