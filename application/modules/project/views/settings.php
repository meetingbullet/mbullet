		...
		<div class="an-component-body">
			<div class="an-helper-block">
				...
				<div class="inline-inputs">
					<div class="input-20">
						<input type="text" class="an-form-control <?php echo (! empty(form_error('cost_of_time_1')) ? 'danger' : '') ?>" name="cost_of_time_1" value="<?php echo set_value('cost_of_time_1', empty($project->cost_of_time_1) ? '' : $project->cost_of_time_1) ?>"/>
					</div>
					<div class="input-20">
						<input type="text" class="an-form-control <?php echo (! empty(form_error('cost_of_time_2')) ? 'danger' : '') ?>" name="cost_of_time_2" value="<?php echo set_value('cost_of_time_2', empty($project->cost_of_time_2) ? '' : $project->cost_of_time_2) ?>"/>
					</div>
					<div class="input-20">
						<input type="text" class="an-form-control <?php echo (! empty(form_error('cost_of_time_3')) ? 'danger' : '') ?>" name="cost_of_time_3" value="<?php echo set_value('cost_of_time_3', empty($project->cost_of_time_3) ? '' : $project->cost_of_time_3) ?>"/>
					</div>
					<div class="input-20">
						<input type="text" class="an-form-control <?php echo (! empty(form_error('cost_of_time_4')) ? 'danger' : '') ?>" name="cost_of_time_4" value="<?php echo set_value('cost_of_time_4', empty($project->cost_of_time_4) ? '' : $project->cost_of_time_4) ?>"/>
					</div>
					<div class="input-20">
						<input type="text" class="an-form-control <?php echo (! empty(form_error('cost_of_time_5')) ? 'danger' : '') ?>" name="cost_of_time_5" value="<?php echo set_value('cost_of_time_5', empty($project->cost_of_time_5) ? '' : $project->cost_of_time_5) ?>"/>
					</div>
					<div class="legend">
