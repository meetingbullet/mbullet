...
$lang['us_waiting_for_confirmation_or_resend_mail'] = 'This email is waiting for confirmation.<br/><a id="resend_confirm_mail" href="%s"><strong>Click here</strong></a> to resend the confirmation email!';
$lang['us_change_email_success'] = 'Your email was changed successfully';
$lang['us_change_email_fail'] = 'There was a problem while updating your email or the confirmation code is expired.<br/>Click the button below to resend the confirmation email!';
$lang['us_resend_confirm_mail'] = 'Resend Confirmation Email';
