	<div class="an-content-body">
		...
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-12 col-lg-6 col-lg-offset-3">
				<div class="an-single-component with-shadow">
					...
					<div class="an-component-body">
						<div class="an-helper-block text-center">
									<div class='avatar' style='background-image:url("<?php echo avatar_url($invitation->inviter_avatar, $invitation->inviter_email, 50) ?>")'></div>
									<i class='ion-ios-plus-empty big-plus'></i>
									<div class='avatar' style='background-image:url("<?php echo avatar_url($invitation->my_avatar, $invitation->my_email, 50) ?>")'></div>
