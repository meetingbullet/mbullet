...
if ($scheduled_start_time = new DateTime($step->scheduled_start_time)) {
	$scheduled_start_time = date_format($scheduled_start_time, 'M d, H:i');
}

if ($scheduled_end_time = new DateTime($step->scheduled_end_time)) {
					...
					<?php echo form_open(site_url('step/update_step_schedule'), ['class' => 'form-inline form-step-schedule']) ?>
						...
						<div class="an input-group">
							...
							<input type="text" 
									name="scheduled_time" 
									class="form-control" 
									value="<?php echo $scheduled_start_time . ' - ' . $scheduled_end_time ?>" 
									placeholder="<?php e(lang('st_time_schedule'))?>" readOnly/>
		...
		<div class="an-component-body an-helper-block">
			<table class="table table-striped table-task">
				...
				<tbody>
					...
					<tr id='task-<?php e($task->task_id)?>' data-task-id='<?php e($task->task_id)?>'>
						...
						<td>
							...
							<button class="an-btn an-btn-primary btn-vote-skip"><?php e(lang('st_vote_skip'))?></button>
							<?php else: ?>
							<button class="an-btn an-btn-primary-transparent" disabled><?php e(lang('st_voted_skip'))?></button>
							<?php endif; ?>
						</td>
						<?php endif; ?>
					</tr>
