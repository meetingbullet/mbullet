...
<div class="btn-block">
	<?php echo anchor(site_url('dashboard'), '<i class="ion-android-arrow-back"></i> ' . lang('st_back'), ['class' => 'an-btn an-btn-primary' ]) ?>
			...
			<div class="an-component-body">
				<div class="an-helper-block meeting-detail">
					...
					<div class="row">
						...
						<div class="col-xs-8 point-used">N/A</div>
					</div>
...
<div id="current-data" style="display: none;"><?php echo json_encode([$invited_members, $meeting, $agendas, $homeworks]); ?></div>
