...
class Home extends Admin_Controller
{
	...
	public function index()
	{
		...
		$login_destination = ($user_role !== false && isset($user_role->login_destination)) ? $user_role->login_destination : '';
		if (isset($login_destination) && !empty($login_destination)) redirect($login_destination);
